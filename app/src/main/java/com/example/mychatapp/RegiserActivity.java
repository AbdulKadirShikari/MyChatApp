...
public class RegiserActivity extends AppCompatActivity {
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if(task.isSuccessful())
                            {
                                ...
                                Toast.makeText(RegiserActivity.this, "Account Created Successfully...", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            }
                            else
                                {
                                ...
                                String message = task.getException().toString();
                                    Toast.makeText(RegiserActivity.this, ""+message, Toast.LENGTH_SHORT).show();
                                    loadingBar.dismiss();
                            }
                        }
                    });
    ...
    private void InitializeFields() {
        ...
        AlreadyHaveAccountLink=(TextView)findViewById(R.id.aready_have_account_link);
    ...
    private void SendUserToMainActivity() {
        Intent mainIntent=new Intent(RegiserActivity.this,MainActivity.class);
